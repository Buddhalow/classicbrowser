...
{
    public partial class XPBrowser : Form
    {
        public XPBrowser()
        {
            InitializeComponent();
        ...
        private void XPBrowser_Load(object sender, EventArgs e)
        {
        ...
        private void Init()
        {
            ...
            webBrowser.LifeSpanHandler = new XPBrowserLifeSpanHandler();
        ...
        public XPBrowser(String url) : this()
        {
            webBrowser.Load(url);
        }
